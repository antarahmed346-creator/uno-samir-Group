...
export function useRealtimeStatus() {
  ...
  useEffect(() => {
    ...
    // WHAT: بنستنى شوية قبل أول محاولة اتصال، بدل ما نبدأها فوراً
    //       لحظة ما الصفحة تفتح
    // WHY:  الكومبوننت ده موجود في كل صفحة عامة في الموقع — يعني
    //       أي تأخير هنا بيأثر على كل صفحة بيفتحها العميل. فتح
    //       اتصال WebSocket فوري بينافس على الموارد مع تحميل باقي
    //       الصفحة (صور، خطوط، إلخ)، فبيخلي الصفحة تحس إنها أبطأ —
    //       خصوصاً إن البانر ده أصلاً بس تحذير ثانوي (الأسعار ممكن
    //       متكونش محدثة لحظياً)، مش وظيفة أساسية للصفحة
    const initialDelay = setTimeout(subscribe, 2500)
