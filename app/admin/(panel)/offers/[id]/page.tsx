  ...
  useEffect(() => {
    if (offer) {
      setForm({
        ...
        max_discount: offer.max_discount ? String(offer.max_discount) : '',
  ...
  if (!offer) {
    return (
      <div dir="rtl" className="p-8 text-center">
        <p className="text-red-600">العرض غير موجود</p>
        <Button variant="link" onClick={() => router.push('/admin/offers')}>
          العودة للعروض
        </Button>
      </div>
    )
    ...
    <div dir="rtl" className="p-6 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={form.brand_id} onValueChange={(v) => handleChange('brand_id', v)}>
                  ...
                  <SelectContent>
                    <SelectItem value="">🍽️ كل البراندات</SelectItem>
                    {brands?.map((brand) => (
        ...
        <div className="flex items-center gap-4">
          <Button type="submit" disabled={updateOffer.isPending} className="bg-orange-500 hover:bg-orange-600">
